...
type ExampleClient interface {
	Get(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Result, error)
}
...
func (c *exampleClient) Get(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Result, error) {
	out := new(Result)
	err := c.cc.Invoke(ctx, "/example.Example/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ExampleServer interface {
	Get(context.Context, *Request) (*Result, error)
...
func (UnimplementedExampleServer) Get(context.Context, *Request) (*Result, error) {
...
func _Example_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/example.Example/Get",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExampleServer).Get(ctx, req.(*Request))
	}
